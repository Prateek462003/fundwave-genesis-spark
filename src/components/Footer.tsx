        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Empowering creators through transparent blockchain crowdfunding.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/explore" className="text-gray-600 hover:text-brand-purple">
                  Explore Campaigns
                </Link>
              </li>
              <li>
                <Link to="/create" className="text-gray-600 hover:text-brand-purple">
                  Start a Campaign
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="text-gray-600 hover:text-brand-purple">
                  Dashboard
                </Link>
              </li>
            </ul>
